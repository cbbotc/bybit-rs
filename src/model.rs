...
pub struct TradingStopRequest<'a> {
    pub category: Category,
    pub symbol: Cow<'a, str>,
    pub take_profit: Option<Cow<'a, str>>,
    pub stop_loss: Option<Cow<'a, str>>,
    pub tp_trigger_by: Option<Cow<'a, str>>,
    pub sl_trigger_by: Option<Cow<'a, str>>,
    pub tpsl_mode: Option<Cow<'a, str>>,
    pub tp_order_type: Option<OrderType>,
    pub sl_order_type: Option<OrderType>,
    pub tp_size: Option<Cow<'a, str>>,
    pub sl_size: Option<Cow<'a, str>>,
    pub tp_limit_price: Option<Cow<'a, str>>,
    pub sl_limit_price: Option<Cow<'a, str>>,
    pub position_idx: i32,
}
...
impl<'a> TradingStopRequest<'a> {
    pub fn new(
        ...
        tp_size: Option<&'a str>,
        sl_size: Option<&'a str>,
        tp_limit_price: Option<&'a str>,
        sl_limit_price: Option<&'a str>,
        position_idx: i32,
    ) -> Self {
        Self {
            category,
            symbol: Cow::Borrowed(symbol),
            take_profit: take_profit.map(|s| Cow::Borrowed(s)),
            stop_loss: stop_loss.map(|s| Cow::Borrowed(s)),
            ...
            tp_order_type,
            sl_order_type,
            tp_size: tp_size.map(|s| Cow::Borrowed(s)),
            sl_size: sl_size.map(|s| Cow::Borrowed(s)),
            tp_limit_price: tp_limit_price.map(|s| Cow::Borrowed(s)),
            sl_limit_price: sl_limit_price.map(|s| Cow::Borrowed(s)),
            position_idx,
        }
    }
